...
if (!preg_match("/(ACT|ABQ|BDE)\-[1-2]\d\d\d/",$webdata['bookingref'] )) {
	$formerror['bookingref'] = '<span class="warn" >Not valid on server: invalid booking reference</span>';
  //echo "Invalid booking reference format"; 
  $valid = FALSE;
}}
?>
